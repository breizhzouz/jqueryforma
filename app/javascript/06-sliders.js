...
$(function () {
    ...
    //recalculer w au changement de winwow resize
    ...
    let id = setInterval(defilRight, 3000);

    // les actions
    //quand on survole un boutton on stop le defilement
    $('.slider span').mouseenter(function () {

        clearInterval(id);

    });
    // quand on quitte un boutton on realnce le défilement
